...
/**
 * 带webView的Activity，用于解决html中的<input type="file"...>控件无法打开上传界面的问题。
 * 可以根据实际需要打开摄像头、摄像机、录音机等
 * @author hxc
 *
 */
...
//        settings.setCacheMode(WebSettings.LOAD_NO_CACHE);
        ...
        settings.setDatabasePath(MyWebViewActivity.this.getApplicationContext().getCacheDir().getAbsolutePath());
...
// TODO Auto-generated method stub
            ...
            MyWebViewActivity.this.setContentView(webview);
        }
    ...
    class MyWebChromeClient extends WebChromeClient {
        ...
        public boolean onJsAlert(WebView view, String url, String message, final JsResult result) {
            ...
            new AlertDialog.Builder(MyWebViewActivity.this).setTitle(newTitle).setMessage(message).setPositiveButton(android.R.string.ok, new DialogInterface.OnClickListener() {
